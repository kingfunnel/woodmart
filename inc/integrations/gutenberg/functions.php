...
if ( ! function_exists( 'woodmart_gutenberg_enqueue_editor_styles' ) ) {
	...
	add_action( 'enqueue_block_editor_assets', 'woodmart_gutenberg_enqueue_editor_styles', 10 );
}
...
if ( ! function_exists( 'woodmart_gutenberg_editor_custom_styles' ) ) {
	...
	add_action( 'enqueue_block_editor_assets', 'woodmart_gutenberg_editor_custom_styles' );
}
