...
$loop_column_tablet        = woodmart_loop_prop( 'columns_tablet', false );
$loop_column_mobile        = woodmart_loop_prop( 'columns_mobile', false );
$classes                   = array();
...
if ( 'carousel' !== $product_categories_style ) {
	if ( $loop_column_tablet || $loop_column_mobile ) {
		$classes[] = woodmart_get_grid_el_class_new( $woocommerce_loop, $different_sizes, $loop_column, $loop_column_tablet, $loop_column_mobile );
	} else {
